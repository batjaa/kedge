...
| Design refresh & i18n | L | Documents list · Projects & tracked repos | specced (2026-07-23) | [specs/m3.7-design-refresh.md](specs/m3.7-design-refresh.md) |
...
- **Design refresh & i18n** (M3.7, wedge 2026-07-23) — the locked Open Harbor baseline product-wide (light-first, self-hosted Space Grotesk display, amended tokens); dashboard upgrade (projects rail, stats strip + workspace summary endpoint, server-side lifecycle filters, audit-log activity feed with review-action instrumentation M5 will reuse); workspace General settings; SaaS marketing landing with the demo import in the hero; web-UI i18n (en-US · es-US · mn-MN · de-DE, negotiated + switchable).
...
- **Design-refresh wedge (M3.7) before M4** — the 2026-07-23 Open Harbor design lock turned into a module: restyle + dashboard/activity + SaaS landing + web-UI i18n, full scope user-directed at speccing (2026-07-23). Landing pulled forward from Launch; activity instrumentation front-runs M5's inbox deliberately.
