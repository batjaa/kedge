...
export function Callout({
  ...
  return (
    <Admonition tone={tone} title={title} {...projectionAttrs}>
      {children}
    </Admonition>
  );
}
...
export function Note({
  ...
  children,
  ...projectionAttrs
}: { title?: ReactNode; children?: ReactNode } & ProjectionAttrs) {
  return (
    <Admonition tone="info" title={title} {...projectionAttrs}>
      {children}
    </Admonition>
  );
}
...
export function Warning({
  ...
  return (
    <Admonition tone="warning" title={title} {...projectionAttrs}>
      {children}
    </Admonition>
  );
}
...
export function Tabs({
  ...
  children,
  ...projectionAttrs
}: { items?: unknown; children?: ReactNode } & ProjectionAttrs) {
