  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="ml-auto rounded-md bg-zinc-400/10 px-1.5 py-0.5 font-mono text-[10px] uppercase text-zinc-500 ring-1 ring-inset ring-zinc-400/30 dark:text-zinc-400">
          {entry.thread.status}
        </span>
      </div>
      {entry.thread.anchor ? (
