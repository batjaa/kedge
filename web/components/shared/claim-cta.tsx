      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-md text-sm leading-6 text-emerald-800/80 dark:text-emerald-200/70">
            Sign up to keep it, share it, and collect comments — before this demo
            expires in 48 hours. It moves into your workspace with nothing lost.
          </p>
        </div>
        <Link
          href={href}
