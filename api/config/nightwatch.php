...
return [
    // Self-host-clean (SPEC "Pluggable services"): Nightwatch is optional
    // SaaS-ops observability. Without a token it must be a full no-op — the
    // open-source app never requires it, same stance as Nova.
    'enabled' => env('NIGHTWATCH_ENABLED', env('NIGHTWATCH_TOKEN') !== null),
