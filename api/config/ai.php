...
/*
|--------------------------------------------------------------------------
| laravel/ai — the provider table (published from the SDK)
|--------------------------------------------------------------------------
|
| Kedge names a provider in exactly two places, both of them config: the
| `AI_PROVIDER` selection in config/kedge.php, and this table — the SDK's own
| list of providers and the credentials each one needs. No application code
| ever mentions a provider (SPEC §14, provider-agnostic by construction).
|
...
return [
    ...
    */
    ...
    'default' => (string) env('AI_PROVIDER', 'anthropic'),
